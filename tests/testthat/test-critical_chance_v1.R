test_that("calculate_critical_chance_v1 is calculating critical chance correctly", {
  ...
  high_crit_attack <- calculate_critical_chance_v1(razor_leaf, speed = 50L, high_crit = 0L)
  expect_identical(high_crit_attack, 200L / 256L)

  high_crit_attack_high_crit <- calculate_critical_chance_v1(razor_leaf, speed = 50L, high_crit = 1L)
